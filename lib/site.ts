...
export const siteConfig = {
  ...
  description:
    "BladeVault is a local-first knife collection manager for Smart Collections, model families, maintenance, comparison, insights, and MCP access.",
  category: "software",
  locale: "en_US",
  url: siteUrl,
  ...
  featureList: [
    "Saved Smart Collections with live result counts",
