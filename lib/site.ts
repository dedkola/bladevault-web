...
export const siteConfig = {
  ...
  description:
    "BladeVault is a local-first desktop knife collection manager for organizing, comparing, and talking to your collection through MCP.",
  category: "software",
  locale: "en_US",
  url: siteUrl,
  ...
  featureList: [
    ...
    "MCP tools for AI-assisted collection search and analysis",
  ],
  videoEntries,
  videoUrl,
}
